...
//    method_exchangeImplementations(class_getInstanceMethod(self, @selector(d)), class_getInstanceMethod(self, @selector(safeDidShowViewController:animated:)));
